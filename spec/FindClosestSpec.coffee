...
describe 'findClosest', ->
  ...
  it 'should work with 1-sized arrays', ->
    expect(findClosest(3, [3])).toEqual(3)
    expect(findClosest(3, [2])).toEqual(2)
    expect(findClosest(3, [4])).toEqual(4)
  it 'should work with 2-sized arrays', ->
    expect(findClosest(3, [0, 1])).toEqual(1)
    expect(findClosest(3, [1, 3])).toEqual(3)
    expect(findClosest(3, [3, 3])).toEqual(3)
    expect(findClosest(3, [3, 5])).toEqual(3)
    expect(findClosest(3, [4, 5])).toEqual(4)
  it 'should work with 3-sized arrays', ->
    expect(findClosest(3, [0, 1, 2])).toEqual(2)
    expect(findClosest(3, [1, 2, 3])).toEqual(3)
    expect(findClosest(3, [2, 3, 4])).toEqual(3)
    expect(findClosest(3, [3, 4, 5])).toEqual(3)
    expect(findClosest(3, [4, 5, 6])).toEqual(4)
    ...
    expect(findClosest(6, [11, 13, 15])).toEqual(11)
  it 'should work with 4-sized arrays', ->
  ...
  it 'should work with float arrays', ->
